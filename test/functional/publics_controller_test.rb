...
class PublicsControllerTest < ActionController::TestCase
  ...
  test "should create public" do
    assert_difference('Public.count') do
      post :create, :public => { :archived => @public.archived, :body => @public.body, :position => @public.position, :title => @public.title }
    end
  ...
  test "should update public" do
    put :update, :id => @public, :public => { :archived => @public.archived, :body => @public.body, :position => @public.position, :title => @public.title }
    assert_redirected_to public_path(assigns(:public))
  end
